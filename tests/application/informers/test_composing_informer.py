...
#     methods = ComposingInformer.__abstractmethods__
#     assert 'list_user_roles' in methods


# async def test_composing_informer_list_user_roles(composing_informer):
#     user_id = '1'
...
# async def test_composing_informer_list_user_roles_(composing_informer):
#     user_id = '1'
#     result = await composing_informer.list_user_roles(user_id)
#     assert isinstance(result, list)
#     assert result[0] == {'ranking_id': '1', 'role': 'admin',
