...
# async def test_json_repository_add_non_existent_file(json_repository):
#     json_repository.data_path = '/tmp/.non_existent_add'
...
# async def test_json_repository_search_non_existent_file(json_repository):
#     json_repository.data_path = '/tmp/.non_existent_file'
#     items = await json_repository.search([])
#     assert len(items) == 0
...
# async def test_json_repository_remove_non_existent_file(json_repository):
#     json_repository.data_path = '/tmp/.non_existent_remove'
